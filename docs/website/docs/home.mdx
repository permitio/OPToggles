...
- OPToggles uses `OPA` to determine the policy true for the user. 
...
Got a more specific question? You can contact us via our [Slack community](https://bitly.com/permit-slack), or reach out via classic email at [support@permit.io](mailto:support@permit.io). Want to dive deeper with our team? You can even [schedule a Zoom call with us](https://calendly.com/permitio/meeting).
